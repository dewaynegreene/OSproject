...
Server will send the cards to each player by turns and will only send to the only player once the other has responded
*/
...
/*void createBoard()
{
   while()
   {
      //random number generator from 1 to 9
      //store a value to that 
   }
}*/
